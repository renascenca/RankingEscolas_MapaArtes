...
function createPopup(currentFeature) {
  ...
  let color;
  if (props["Tipo de ensino"] === "Escola artística") {
    color = "#BEAC37";
  } else if (
    props["Tipo de ensino"] === "Ensino Secundário com Artes Visuais"
  ) {
    color = "#FF999B";
  } else if (props["Tipo de ensino"] === "Escola profissional") {
    color = "#273343";
  }
  ...
  const popupContent = `
        <div>
            ...
            <p style="color: ${color}; font-weight: bold;">Escola ${
    props["Tipo de escola"]
  }</p>
            <p>${props["Vertente no secundário"]}</p>
        </div>
    `;
...
function buildLocationList(locationData) {
  ...
  locationData.features.forEach(function (location, i) {
    ...
    let color;
    if (prop["Tipo de ensino"] === "Escola artística") {
      color = "#BEAC37";
    } else if (
      prop["Tipo de ensino"] === "Ensino Secundário com Artes Visuais"
    ) {
      color = "#FF999B";
    } else if (prop["Tipo de ensino"] === "Escola profissional") {
      color = "#273343";
    }

    link.innerHTML =
      '<p style="line-height: 1.25; color: ' +
      color +
      '">' +
